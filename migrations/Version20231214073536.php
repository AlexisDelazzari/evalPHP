 ...
 */
final class Version20231214073536 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE generated_champion_legendary_item (generated_champion_id INT NOT NULL, item_id INT NOT NULL, INDEX IDX_81DED00E126F525E (item_id), INDEX IDX_81DED00E126217E (generated_champion_id), PRIMARY KEY(generated_champion_id, item_id)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE generated_champion_mythic_item (generated_champion_id INT NOT NULL, item_id INT NOT NULL, INDEX IDX_541F37F5126F525E (item_id), INDEX IDX_541F37F5126217E (generated_champion_id), PRIMARY KEY(generated_champion_id, item_id)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = InnoDB COMMENT = \'\' ');
