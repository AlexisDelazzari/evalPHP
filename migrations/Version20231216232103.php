 ...
 */
final class Version20231216232103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE random_name (id INT AUTO_INCREMENT NOT NULL, generated_champion_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_3F5C186F126217E (generated_champion_id), PRIMARY KEY(id))   ENGINE = InnoDB');
